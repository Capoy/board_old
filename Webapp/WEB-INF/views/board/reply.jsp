				...
				<form method="post" action="${pageContext.request.contextPath }/board/reply">
					...
					<div id="board_content" class="boxshadow">
						<div>
							...
							<input type="hidden" name="group_no" value="${boardVO.group_no }">
							<input type="hidden" name="order_no" value="${boardVO.order_no }">
							...
							<table>
								<tr>
									<th>TITLE</th>
									<td><input type="text" name="title" class="form-control" value="${boardVO.title }" required></input></td>
								</tr>
								<tr>
									<th>CONTENT</th>
